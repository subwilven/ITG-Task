...
public class MainActivity extends BaseNavigationActivity {
    ...
    public void onLaunch() {
        initNavigation(new Class[]{Fragment1.class, Fragment2.class, Fragment4.class, SettingsFragment.class},
                new int[]{R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow,R.id.nav_settings},
